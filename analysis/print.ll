...
$"??_C@_03OHEJPPDF@?$CFp?6?$AA@" = comdat any
...
define external void @print_i64(i64 %val) noinline nounwind optnone uwtable { 
  %_0 = call i32(ptr, ...) @printf(ptr noundef @"??_C@_03PMGGPEJJ@?$CFd?6?$AA@", i64 noundef %val) 
  ret void 
}
